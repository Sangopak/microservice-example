...
import com.sango.microservice.microservice.dao.PostRepository;
...
public class PostResource {
	...
	public ResponseEntity<Post> addUserPosts(@PathVariable final Integer id, @RequestBody final Post post){
