...
public class PostResource {
	...
	@GetMapping(path="versioning/parm",params="ver=1")
	public PostV1 parmVersioningV1() {
		return new PostV1(new Date(),"Some Stupid FB post","FB");
	}
	
	@GetMapping(path="versioning/parm",params="ver=2")
	...
	@GetMapping(path="versioning/produces",produces="application/whatever-v1+json")
	public PostV1 producesVersioningV1() {
		return new PostV1(new Date(),"Some Stupid FB post","FB");
	}
	
	@GetMapping(path="versioning/produces",produces="application/whatever-v2+json")
